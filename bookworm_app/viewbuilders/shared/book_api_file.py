...
def search(sterm, stitle, sauthor, sgenre, sisbn, maxres):
    if stitle != '':
        sterm += '+intitle:' + stitle
    if sauthor != '':
        sterm += '+inauthor:' + sauthor
    if sgenre != '':
        sterm += '+subject:' + sgenre
    if sisbn != '':
        sterm += 'isbn:' + sisbn
...
#     #    print 'ISBN: %d'
#     print 'Title: %s, Authors: %s, Pages: %d' % (
